...
//variable and functions to allow viewer interactivity to be added to a chapter
...
/* Here we add the extra layers we are using. At the end, however, we setup the functions that will tie the
  ...
  map.addLayer(
    {
      ...
      'paint': {
        ...
        "circle-radius": ["interpolate", ["linear"], ["zoom"], 0, 2, 22, 5],
      },
    },
    "road-label-simple",
   ); 
