...
'<video width="500px" 
        ...
        <source 
                src=
"https://www.bpmcdn.com/files/nunavut/import/videos/2020_06_MVI_8008.mp4" 
                type="video/mp4" />
       </video>' +
  
  //'<video width="500" src="https://www.bpmcdn.com/files/nunavut/import/videos/2020_06_MVI_8008.mp4" >' +
...
var config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      onChapterEnter: [
        {
          layer: "data./highwayoftears.html",
          opacity: 0.8,
          duration: 300,
        },
      ],
